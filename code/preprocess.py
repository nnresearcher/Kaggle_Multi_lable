...
print('creat model')
model = createmymodel(input_shape=input_shape, classes=classes, dropout=dropout)


print('load model para')
version=2
check_point_file = r"../data/model/densenet_check_point_v" + str(version) + ".h5"
...
save_csv.to_csv('submission.csv', index=False)
     
#print('predict')
#prop=[]
#prop = modelpredict('../data/validation/2.jpg', model, target_size)
...
#rankdata = pd.read_csv(sample_csv, header=None)
